...
# Mock psi, because MCDR is not running while docs building.
from unittest.mock import MagicMock

mock_mcdr = MagicMock()
sys.modules["mcdreforged.plugin.si.server_interface"] = mock_mcdr

import location_api.api as loc_api  # noqa: E402

# -- Project information -----------------------------------------------------
project = "LocationAPI"
copyright = f"{datetime.datetime.now().year}, Mooling0602"
author = "Mooling0602"
release = loc_api.version
...
# Set to "zh" will make search features broken because of upstream issues.
