...
class TestPositionParsing(unittest.TestCase):
    ...
    def test_get_point3d_from_server_reply_normal_with_d_suffix(self):
        ...
        self.assertAlmostEqual(result.x, -524.5, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.y, 71.0, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.z, -66.5, places=3)  # ty: ignore[possibly-missing-attribute]
    ...
    def test_get_point3d_from_server_reply_without_d_suffix(self):
        ...
        self.assertIsNotNone(result)
        self.assertAlmostEqual(result.x, -100, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.y, 200.5, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.z, 300.75, places=3)  # ty: ignore[possibly-missing-attribute]
    ...
    def test_get_point3d_from_server_reply_player_name_matching(self):
        ...
        self.assertIsNotNone(result)
        self.assertAlmostEqual(result.x, 10.0, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.y, 20.0, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.z, 30.0, places=3)  # ty: ignore[possibly-missing-attribute]
    ...
    def test_get_point3d_from_server_reply_invalid_format_raises_typeerror(
        self,
    ):
    ...
    def test_get_point3d_from_server_reply_custom_regex(self):
        ...
        self.assertIsNotNone(result)
        self.assertAlmostEqual(result.x, 1.0, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.y, 2.0, places=3)  # ty: ignore[possibly-missing-attribute]
        self.assertAlmostEqual(result.z, 3.0, places=3)  # ty: ignore[possibly-missing-attribute]
    ...
    def test_get_point3d_from_server_reply_invalid_number_format(self):
        ...
        self.assertIn(
            "Could not convert matched values to float", str(context.exception)
        )
